...
def profile_location profile_name
    "#{File.dirname(profile_name)}/#{File.basename(profile_name, ".yaml")}.yaml"
end
...
def load_profile profile_name
    ...
    begin
        profile = YAML.load_file "#{profile_location(profile_name)}"
    rescue
        raise "Profile '#{profile_location(profile_name)}' doesn't exist"
    end
